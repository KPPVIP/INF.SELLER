    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'info',
      {
		...
		--if data.current.value == 'ogkush' then
           --TriggerServerEvent("polo_pisteillegal:OgKush")
		   --ESX.UI.Menu.CloseAll()
        --end
		
		--if data.current.value == 'togkush' then
           --TriggerServerEvent("polo_pisteillegal:TOgKush")
		   --ESX.UI.Menu.CloseAll()
        --end
		
		--if data.current.value == 'SellTurtle' then
           --TriggerServerEvent("polo_pisteillegal:SellTurtle")
		   --ESX.UI.Menu.CloseAll()
        --end
		
		--if data.current.value == 'SellShark' then
           --TriggerServerEvent("polo_pisteillegal:SellShark")
		   --ESX.UI.Menu.CloseAll()
        --end
		
		--if data.current.value == 'wash' then
           --TriggerServerEvent("polo_pisteillegal:wash")
		   --ESX.UI.Menu.CloseAll()
        --end
...
--RegisterNetEvent("polo_pisteillegal:OgkushFarm")
--AddEventHandler("polo_pisteillegal:OgkushFarm", function()
	--if Config.GPS then
		--x, y, z = Config.MethFarm.x, Config.MethFarm.y, Config.MethFarm.z
		--SetNewWaypoint(x, y, z)
		--local source = GetPlayerServerId();
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('GPS'))
	--else
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('RecOgkush'))
	--end
--end)

--RegisterNetEvent("polo_pisteillegal:OgkushTreatment")
--AddEventHandler("polo_pisteillegal:OgkushTreatment", function()
	--if Config.GPS then
		...
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('GPS'))
	--else
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('TraiOgkush1'))
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('TraiOgkush'))
	--end
--end)

--RegisterNetEvent("polo_pisteillegal:Turtle")
--AddEventHandler("polo_pisteillegal:Turtle", function()
	--if Config.GPS then
		...
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('GPS'))
	--else
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('SellTurtle1'))
	--end
--end)

--RegisterNetEvent("polo_pisteillegal:Shark")
--AddEventHandler("polo_pisteillegal:Shark", function()
	--if Config.GPS then
		...
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('GPS'))
	--else
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('SellShark1'))
	--end
--end)

--RegisterNetEvent("polo_pisteillegal:washmoney")
--AddEventHandler("polo_pisteillegal:washmoney", function()
	--if Config.GPS then
		...
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('GPS'))
	--else
		--TriggerEvent("polo_pisteillegal:notify", "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('Recwash'))
	--end
--end)
